      ...
      <form onSubmit={handleSubmit}>
        <div className='flex gap-3'>
          <input
            ...
            className='flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-100 text-gray-900 placeholder-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100 dark:placeholder-gray-400'
          />
          <button
            type='submit'
          ...
          >
            ...
            <span className='hidden md:inline'>Search Issues</span>
          </button>
        </div>
      </form>
    </div>
