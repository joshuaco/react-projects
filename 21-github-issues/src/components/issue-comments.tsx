  ...
  return (
    <div className='space-y-6'>
      {comments.map((comment) => (
        <div
          key={comment.id}
          className='flex gap-4 p-6 bg-white rounded-lg border border-gray-200 hover:shadow-sm transition-shadow overflow-x-auto dark:bg-gray-800 dark:border-gray-700'
        >
          <img
          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='markdown-content text-gray-700 text-sm leading-relaxed dark:text-gray-100'>
