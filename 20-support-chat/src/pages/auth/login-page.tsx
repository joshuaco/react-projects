...
import { loginUser } from "@/mock/fake-data"
import { cn } from "@/lib/utils"
import loginImage from "@/assets/placeholder.svg"
...
export default function LoginPage({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const onSocialLogin = (buttonId: string) => {
          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" className="w-full" onClick={() => onSocialLogin('apple')}>
                  {isPending && activeButton === 'apple' ? (
                ...
                <Button variant="outline" className="w-full" onClick={() => onSocialLogin('meta')}>
                  {isPending && activeButton === 'meta' ? (
                    <Loader2 className="h-4 w-4 animate-spin" />
                  ) : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
